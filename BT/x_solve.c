    ...
    for (j = 1; j <= grid_points[1]-2; j++) {
      for (i = 1; i <= isize-1; i++) {
		...
		for(z = a; z <= b; z++){  
			...
			fjac[i + z][0][1] = -(u[k][j][i + z][1] * tmp2 * u[k][j][i + z][1])
			  + c2 * qs[k][j][i + z];
			fjac[i + z][1][1] = ( 2.0 - c2 ) * ( u[k][j][i + z][1] / u[k][j][i + z][0] );
			fjac[i + z][2][1] = - c2 * ( u[k][j][i + z][2] * tmp1 );
			fjac[i + z][3][1] = - c2 * ( u[k][j][i + z][3] * tmp1 );
			fjac[i + z][4][1] = c2;

			fjac[i + z][0][2] = - ( u[k][j][i + z][1]*u[k][j][i + z][2] ) * tmp2;
			fjac[i + z][1][2] = u[k][j][i + z][2] * tmp1;
			fjac[i + z][2][2] = u[k][j][i + z][1] * tmp1;
			fjac[i + z][3][2] = 0.0;
			fjac[i + z][4][2] = 0.0;

			fjac[i + z][0][3] = - ( u[k][j][i + z][1]*u[k][j][i + z][3] ) * tmp2;
			fjac[i + z][1][3] = u[k][j][i + z][3] * tmp1;
			fjac[i + z][2][3] = 0.0;
			fjac[i + z][3][3] = u[k][j][i + z][1] * tmp1;
			fjac[i + z][4][3] = 0.0;

			fjac[i + z][0][4] = ( c2 * 2.0 * square[k][j][i + z] - c1 * u[k][j][i + z][4] )
			  * ( u[k][j][i + z][1] * tmp2 );
			fjac[i + z][1][4] = c1 *  u[k][j][i + z][4] * tmp1 
			  - c2 * ( u[k][j][i + z][1]*u[k][j][i + z][1] * tmp2 + qs[k][j][i + z] );
			fjac[i + z][2][4] = - c2 * ( u[k][j][i + z][2]*u[k][j][i + z][1] ) * tmp2;
			fjac[i + z][3][4] = - c2 * ( u[k][j][i + z][3]*u[k][j][i + z][1] ) * tmp2;
			fjac[i + z][4][4] = c1 * ( u[k][j][i + z][1] * tmp1 );
			...
			njac[i + z][0][1] = - con43 * c3c4 * tmp2 * u[k][j][i + z][1];
			njac[i + z][1][1] =   con43 * c3c4 * tmp1;
			njac[i + z][2][1] =   0.0;
			njac[i + z][3][1] =   0.0;
			njac[i + z][4][1] =   0.0;

			njac[i + z][0][2] = - c3c4 * tmp2 * u[k][j][i + z][2];
			njac[i + z][1][2] =   0.0;
			njac[i + z][2][2] =   c3c4 * tmp1;
			njac[i + z][3][2] =   0.0;
			njac[i + z][4][2] =   0.0;

			njac[i + z][0][3] = - c3c4 * tmp2 * u[k][j][i + z][3];
			njac[i + z][1][3] =   0.0;
			njac[i + z][2][3] =   0.0;
			...
			njac[i + z][0][4] = - ( con43 * c3c4
				- c1345 ) * tmp3 * (u[k][j][i + z][1]*u[k][j][i + z][1])
			  - ( c3c4 - c1345 ) * tmp3 * (u[k][j][i + z][2]*u[k][j][i + z][2])
			  - ( c3c4 - c1345 ) * tmp3 * (u[k][j][i + z][3]*u[k][j][i + z][3])
			  - c1345 * tmp2 * u[k][j][i + z][4];

			njac[i + z][1][4] = ( con43 * c3c4
				- c1345 ) * tmp2 * u[k][j][i + z][1];
			njac[i + z][2][4] = ( c3c4 - c1345 ) * tmp2 * u[k][j][i + z][2];
			njac[i + z][3][4] = ( c3c4 - c1345 ) * tmp2 * u[k][j][i + z][3];
