  ...
  for (k = 1; k <= grid_points[2]-2; k++) {
    for (i = 1; i <= grid_points[0]-2; i++) {
      for (j = 1; j <= jsize-1; j++) {
		...
		for(z = a; z <= b; z++){
			tmp1 = (*(double *)dvmh_get_element_addr_C(rho_i, 3, DVM0C(k), DVM0C(j + z), DVM0C(i)));
			tmp2 = tmp1 * tmp1;
			tmp3 = tmp1 * tmp2;
			...
			fjac[j + z][0][1] = - ( (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) ) * tmp2;
			fjac[j + z][1][1] = (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp1;
			fjac[j + z][2][1] = (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1))) * tmp1;
			fjac[j + z][3][1] = 0.0;
			fjac[j + z][4][1] = 0.0;

			fjac[j + z][0][2] = - ( (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)))*tmp2)
			  + c2 * (*(double *)dvmh_get_element_addr_C(qs, 3, DVM0C(k), DVM0C(j + z), DVM0C(i)));
			fjac[j + z][1][2] = - c2 *  (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1))) * tmp1;
			fjac[j + z][2][2] = ( 2.0 - c2 ) *  (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp1;
			fjac[j + z][3][2] = - c2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3))) * tmp1;
			fjac[j + z][4][2] = c2;

			fjac[j + z][0][3] = - ( (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3))) ) * tmp2;
			fjac[j + z][1][3] = 0.0;
			fjac[j + z][2][3] = (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3))) * tmp1;
			fjac[j + z][3][3] = (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp1;
			fjac[j + z][4][3] = 0.0;

			fjac[j + z][0][4] = ( c2 * 2.0 * (*(double *)dvmh_get_element_addr_C(square, 3, DVM0C(k), DVM0C(j + z), DVM0C(i))) - c1 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(4))) )
			  * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp2;
			fjac[j + z][1][4] = - c2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp2;
			fjac[j + z][2][4] = c1 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(4))) * tmp1 
			  - c2 * ( (*(double *)dvmh_get_element_addr_C(qs, 3, DVM0C(k), DVM0C(j + z), DVM0C(i))) + (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp2 );
			fjac[j + z][3][4] = - c2 * ( (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3))) ) * tmp2;
			fjac[j + z][4][4] = c1 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))) * tmp1;
			...
			njac[j + z][0][1] = - c3c4 * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1)));
			njac[j + z][1][1] =   c3c4 * tmp1;
			njac[j + z][2][1] =   0.0;
			njac[j + z][3][1] =   0.0;
			njac[j + z][4][1] =   0.0;

			njac[j + z][0][2] = - con43 * c3c4 * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)));
			njac[j + z][1][2] =   0.0;
			njac[j + z][2][2] =   con43 * c3c4 * tmp1;
			njac[j + z][3][2] =   0.0;
			njac[j + z][4][2] =   0.0;

			njac[j + z][0][3] = - c3c4 * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3)));
			njac[j + z][1][3] =   0.0;
			njac[j + z][2][3] =   0.0;
			njac[j + z][3][3] =   c3c4 * tmp1;
			njac[j + z][4][3] =   0.0;

			njac[j + z][0][4] = - (  c3c4
				- c1345 ) * tmp3 * ((*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1))))
			  - ( con43 * c3c4
				  - c1345 ) * tmp3 * ((*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2))))
			  - ( c3c4 - c1345 ) * tmp3 * ((*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3)))*(*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3))))
			  - c1345 * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(4)));

			njac[j + z][1][4] = (  c3c4 - c1345 ) * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(1)));
			njac[j + z][2][4] = ( con43 * c3c4 - c1345 ) * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(2)));
			njac[j + z][3][4] = ( c3c4 - c1345 ) * tmp2 * (*(double *)dvmh_get_element_addr_C(u, 4, DVM0C(k), DVM0C(j + z), DVM0C(i), DVM0C(3)));
			njac[j + z][4][4] = ( c1345 ) * tmp1;
		}
      //}
